...
class TransferAlifCardAdapter (var mList: List<TransferAlifCardData>) :
    RecyclerView.Adapter<TransferAlifCardAdapter.AlifCardViewHolder>(){
    ...
    override fun onBindViewHolder(holder: AlifCardViewHolder, position: Int) {
